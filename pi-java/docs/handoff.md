...
1. `pi-cli` / `pi-sdk`：继续下沉 instruction-resource-aware system prompt 组合逻辑
2. `pi-cli`：继续补 real module wiring 的 help/version、`@file`、interactive exit 语义
