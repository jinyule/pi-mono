...
1. `pi-cli`：把 `reload` 从 settings/resources 首版继续接到 extension runtime / startup pipeline
2. `pi-cli` / `pi-sdk`：继续下沉 instruction-resource-aware system prompt 组合逻辑
