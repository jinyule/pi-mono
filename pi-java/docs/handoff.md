...
The current implementation hotspot is phase 9 release follow-through now that package auth, package commands, package config, path overrides, and basic distribution outputs all exist.
...
8. `pi-java/docs/handoff/phase-9-package-sources-distribution-packaged-assets.md`
9. `pi-java/docs/handoff/phase-9-package-sources-distribution-paths.md`
10. `pi-java/docs/handoff/phase-9-package-sources-distribution-package-manager.md`
11. `pi-java/docs/handoff/phase-9-package-sources-distribution-foundation.md`
12. `pi-java/docs/handoff/phase-8-behavior-parity.md`
13. `pi-java/docs/handoff/phase-7-pi-cli-sdk.md`
14. `pi-java/docs/handoff/phase-6-pi-tui.md`
15. `pi-java/docs/handoff/archive-2026-03-10.md`
16. `pi-java/docs/handoff/README.md`
