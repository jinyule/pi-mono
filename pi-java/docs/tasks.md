...
- Phase 8 (behavior parity): in progress.
  ...
  - Interactive command/status copy continues to converge, including TypeScript-aligned tree-navigation success wording, tree empty-state wording, and fork-selector success wording.
