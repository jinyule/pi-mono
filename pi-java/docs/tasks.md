...
- Phase 8 (behavior parity): in progress.
  ...
  - Settings/theme parity is substantially advanced, including removal of the extra theme-submenu `(current)` marker and removal of the Java-only settings title/top-help block in favor of TypeScript-style border-only framing.
