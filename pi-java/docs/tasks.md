...
- 阶段 3：已完成 `SessionHeader / SessionEntry / SessionTreeNode / SessionContext / SessionDocument`、`Session JSONL parse/write skeleton` 与 seed fixture parse/write tests。
- 阶段 3：下一步补 `migration / replay`。
- 阶段 4 到阶段 9：未开始。
