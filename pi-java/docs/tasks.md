...
- Phase 8 (behavior parity): in progress.
  ...
  - Settings/theme parity is substantially advanced, including removal of the extra theme-submenu `(current)` marker so the theme list now matches the TypeScript selector more closely.
